package com.example.jwt.allJWT;
...
public class JwtHelper {
    ...
    public static final long JWT_TOKEN_VALIDITY = 5 * 60 * 60; // 5 hours 60 min 60 sec

    // Use a Key object instead of a plain String for the secret
    ...
    // 2. Sign the JWT using HS512 and the secret key
